...
FriendTableNameDecrypted = ENV['friend_table']

FriendTableBySubIdIndexNameEncrypted = ENV['friend_table_bySubId_index']
FriendTableBySubIdIndexNameDecrypted = ENV['friend_table_bySubId_index']

FriendTableByFriendSubIdIndexNameEncrypted = ENV['friend_table_byFriendSubId_index']
FriendTableByFriendSubIdIndexNameDecrypted = ENV['friend_table_byFriendSubId_index']

FriendTableByFriendStatusIndexNameEncrypted = ENV['friend_table_byFriendStatus_index']
FriendTableByFriendStatusIndexNameDecrypted = ENV['friend_table_byFriendStatus_index']

DynamoDBRegionEncrypted = ENV['dynamodb_region']
DynamoDBRegionDecrypted = ENV['dynamodb_region']
