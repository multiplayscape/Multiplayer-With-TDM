...
UserActivitiesTableNameDecrypted = ENV['user_activities_table']

InvitationTableNameEncrypted = ENV['invitation_table']
InvitationTableNameDecrypted = ENV['invitation_table']
...
CognitoUserPoolIdDecrypted = ENV['user_pool_id']

CognitoRegionEncrypted = ENV['cognito_region']
CognitoRegionDecrypted = ENV['cognito_region']
...
EmailSenderDecrypted = ENV['email_sender']

SESRegionEncrypted = ENV['ses_region']
SESRegionDecrypted = ENV['ses_region']
